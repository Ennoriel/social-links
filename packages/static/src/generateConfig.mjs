export default [
	{
		...
		args: [
			{
				description:
					'url of the page you are sharing. Facebook will crawl the url to retrieve open graph attributes',
				key: 'u',
				propsName: 'url',
				type: 'string'
			},
			{
				description:
					'unique hashtag that will be added at the end of the Facebook post. It should be provided without the "#" character',
				key: 'hashtag',
				type: 'string',
				optional: true,
				prefix: '#'
	...
	},
	{
		...
		args: [
			{
				description:
					'url of the page you are sharing. Leave url blank to submit a question for discussion. If there is no url, text will appear at the top of the thread. If there is a url, text is optional.',
				key: 'u',
				propsName: 'url',
				type: 'string',
				optional: true
	...
	},
	{
		...
		args: [
			{
				description:
					'title of the page you are sharing. <!-- fgujnbnj #lul http://localhost:5173/ #lol #lil via @via -->',
				key: 'title',
				type: 'string'
			},
			{
